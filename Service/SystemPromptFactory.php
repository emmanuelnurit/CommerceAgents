...
final readonly class SystemPromptFactory
{
    public function shopping(string $assistantName, string $locale): string
    {
        return sprintf(
            ...
            .'store pages, not the catalog); if the visitor gives no keyword, call search_products '
            .'with a broad term rather than an empty query. '
            .'Do not repeat a tool call that already returned a result. If search_products returns no '
            .'products, do not keep guessing other keywords: tell the visitor nothing matched and ask '
